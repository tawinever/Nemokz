...
$(document).on('focusout', 'input.validate, textarea.validate', function() {
	if ($(this).hasClass('is_required') || $(this).val().length)
	{
		if ($(this).attr('data-validate') != 'none')
		{
			...
			if (result)
				$(this).parents('.opc-form-group').first().removeClass('opc-has-error').addClass('opc-has-success');
			else
				$(this).parents('.opc-form-group').first().addClass('opc-has-error').removeClass('opc-has-success');
		}
	}
});
