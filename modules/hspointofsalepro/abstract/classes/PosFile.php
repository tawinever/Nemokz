...
class PosFile
{
        ...
        if (!empty($directories)) {
            ...
            foreach ($directories as $directory) {
                ...
                foreach ($item as $file) {
                    $success &=(is_dir("$directory_path/$file")) ? PosFile::deleteDirectories($directory_path, array($file)) : unlink("$directory_path/$file");
                }
     ...
     * 
     */
    public static function getResizedFileSizes($max_height, $file_path)
    {
        ...
        if ($real_height > $max_height) {
            ...
            $resize_file_sizes['height'] = $max_height;
            $resize_file_sizes['width'] = $ratio * $real_width;
        } else {
