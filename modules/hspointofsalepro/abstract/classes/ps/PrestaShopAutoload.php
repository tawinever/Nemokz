...
class PrestaShopAutoload
{
    ...
    public function load($classname)
    {
        ...
        if (Tools::substr($classname, -4) != 'Core') {
        ...
        } elseif (isset($this->index[$classname]['path']) && $this->index[$classname]['path']) { // Call directly ProductCore, ShopCore class
    ...
    public function generateIndex()
    {
        ...
        } else { // $filename_tmp couldn't be written. $filename should be there anyway (even if outdated), no need to die.
