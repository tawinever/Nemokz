...
<!--                                        <div class="separator bottom"></div> -->
                            ...
                            <div id="content">
								...
								<tr class="free-disabled">
                                    <td class="name vertical_top_align"><span class="control-label">{l s='Delivery address for virtual cart' mod='supercheckout'}: </span>
                                                                        ...
                                                                        <td class="left settings">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                <label class="radio coupon_type_radio">
                                                                                    <input type="radio" class="radio coupon_type_radio"  value="0"  {if $velocity_supercheckout['checkout_option'] eq 0} checked="checked" {/if} disabled/>{l s='Login' mod='supercheckout'}                                                                        
                                                                                </label>
                                                                                <label class="radio coupon_type_radio">
                                                                                    <input type="radio" class="radio coupon_type_radio"  value="1" {if $velocity_supercheckout['checkout_option'] eq 1} checked="checked" {/if} disabled/>{l s='Guest' mod='supercheckout'}                                                                        
                                                                                </label>
                                                                                <label class="radio coupon_type_radio">
                                                                                    <input type="radio" class="radio coupon_type_radio"  value="2" {if $velocity_supercheckout['checkout_option'] eq 2} checked="checked" {/if} disabled/>{l s='Register' mod='supercheckout'}                                                                        
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input" onchange="bg_changer(this.color);"   value="{$velocity_supercheckout['customizer']['button_color']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input"  onchange="border_changer(this.color);"  value="{$velocity_supercheckout['customizer']['button_border_color']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                       ...
                                                                       <tr>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input"  onchange="text_changer(this.color);" value="{$velocity_supercheckout['customizer']['button_text_color']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                   ...
                                                                                   <input type="text" class="color form-control colorizer-input" onchange="border_bottom_changer(this.color);"  value="{$velocity_supercheckout['customizer']['border_bottom_color']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <textarea rows="5" style="resize: both;" class="vss_sc_ver15" disabled>{if isset($velocity_supercheckout['custom_css'])}{$velocity_supercheckout['custom_css']}{/if}</textarea>{*Variable contains css content, escape not required*}
                                                                        </td>                                                                        
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="name vertical_top_align" style="padding: 15px;">
                                                                        ...
                                                                        <td class="settings" style="padding: 15px;">
                                                                            <textarea rows="5" style="resize: both;" class="vss_sc_ver15" disabled>{if isset($velocity_supercheckout['custom_js'])}{$velocity_supercheckout['custom_js']}{/if}</textarea>{*Variable contains js content, escape not required*}
                                                                        </td>                                                                        
                                                                    </tr>
                                    ...
                                    <tr class="free-disabled">
                                                                    ...
                                                                    <tr class="free-disabled">
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width"  value="{$velocity_supercheckout['fb_login']['app_id']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                    ...
                                                                    <tr class="free-disabled">
                                                                        ...
                                                                        <td class="settings" >
                                                                            <input type="text" class="text-width"  value="{$velocity_supercheckout['fb_login']['app_secret']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                    ...
                                                                    <tr class="free-disabled">
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width"  value="{$velocity_supercheckout['google_login']['client_id']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                    ...
                                                                    <tr class="free-disabled">
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width"  value="{$velocity_supercheckout['google_login']['app_secret']|escape:'htmlall':'UTF-8'}" disabled/>
						    ...
						    <!--------------- Start - Mailchimp -------------------->
                                                                        ...
                                                                        <td class="settings">
                                                                            ...
                                                                            <div class="widget-body uniformjs" style="padding-top: 1%;">
                                                                                    ...
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option" value="1" {if isset($velocity_supercheckout['mailchimp']['default']) && $velocity_supercheckout['mailchimp']['default'] eq 1}checked="checked"{/if} disabled/>{l s='Subscribe customers as soon as they come out from Email field' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                        </td>
                                                                    </tr>
									  <tr>
										...
										<span style="display: inline-block;width:75%;">
                                                                            <input type="text" class="text-width"  value="{if isset($velocity_supercheckout['mailchimp']['api'])}{$velocity_supercheckout['mailchimp']['api']|escape:'htmlall':'UTF-8'}{/if}" id="supercheckout_mailchimp_key" disabled/>
									    <input type="hidden" class="text-width"  value="{if isset($velocity_supercheckout['mailchimp']['list'])}{$velocity_supercheckout['mailchimp']['list']|escape:'htmlall':'UTF-8'}{/if}" id="supercheckout_mailchimp_list" disabled/>
									    </span>
							...
							<!--------------- End - Mailchimp -------------------->    
                                                            ...
                                                            <table class="form alternate">
                                                                ...
                                                                <tbody class="sortable ui-sortable">
                                                                    {foreach from=$velocity_supercheckout['customer_personal'] key='k' item = 'p_addr'}
                                                                        <tr id="customer_personal_{$velocity_supercheckout['customer_personal'][$k]['id']|escape:'htmlall':'UTF-8'}_input" class="sort-item free-disabled" sort-data="{if isset($velocity_supercheckout['customer_personal'][$k]['sort_order'])}{$velocity_supercheckout['customer_personal'][$k]['sort_order']|intval}{/if}">
                                                                            <input type="hidden" value="{$velocity_supercheckout['customer_personal'][$k]['id']|escape:'htmlall':'UTF-8'}"  disabled/>
                                                                            <input type="hidden" value="{$velocity_supercheckout['customer_personal'][$k]['title']|escape:'htmlall':'UTF-8'}"  disabled/>
                                                                            <td class="name">
                                                                               <span>{l s=$velocity_supercheckout['customer_personal'][$k]['title']|escape:'htmlall' mod='supercheckout'}:<input class="sort" class="input-sm form-control col-md-12" type="text" value="{if isset($velocity_supercheckout['customer_personal'][$k]['sort_order'])}{$velocity_supercheckout['customer_personal'][$k]['sort_order']|intval}{/if}" disabled/></span>
                                                                            </td>
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_personal_guest_{$k|escape:'htmlall':'UTF-8'}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field"  value="{$velocity_supercheckout['customer_personal'][$k]['guest']['require']|intval}" {if $velocity_supercheckout['customer_personal'][$k]['guest']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_personal_guest_{$k|escape:'htmlall':'UTF-8'}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field"  value="{$velocity_supercheckout['customer_personal'][$k]['guest']['display']|intval}" {if $velocity_supercheckout['customer_personal'][$k]['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_personal_logged_{$k|escape:'htmlall':'UTF-8'}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field"  value="{$velocity_supercheckout['customer_personal'][$k]['logged']['require']|intval}" {if $velocity_supercheckout['customer_personal'][$k]['logged']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_personal_logged_{$k|escape:'htmlall':'UTF-8'}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field"  value="{$velocity_supercheckout['customer_personal'][$k]['logged']['display']|intval}" {if $velocity_supercheckout['customer_personal'][$k]['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="reorder">
                                                            ...
                                                            <table class="form alternate">
                                                                ...
                                                                <tbody class="sortable ui-sortable">
                                                                    {foreach from=$velocity_supercheckout['customer_subscription'] key='k' item = 'p_addr'}
                                                                        <tr id="customer_subsription_{$velocity_supercheckout['customer_subscription'][$k]['id']|escape:'htmlall':'UTF-8'}_input" class="sort-item free-disabled" sort-data="{if isset($velocity_supercheckout['customer_subscription'][$k]['sort_order'])}{$velocity_supercheckout['customer_subscription'][$k]['sort_order']|intval}{/if}">
                                                                            <input type="hidden" value="{$velocity_supercheckout['customer_subscription'][$k]['id']|escape:'htmlall':'UTF-8'}"  disabled/>
                                                                            <input type="hidden" value="{$velocity_supercheckout['customer_subscription'][$k]['title']|escape:'htmlall':'UTF-8'}"  disabled/>
                                                                            <td class="name">
                                                                               <span>{l s=$velocity_supercheckout['customer_subscription'][$k]['title']|escape:'htmlall' mod='supercheckout'}:<input class="sort" class="input-sm form-control col-md-12" type="text" value="{if isset($velocity_supercheckout['customer_subscription'][$k]['sort_order'])}{$velocity_supercheckout['customer_subscription'][$k]['sort_order']|intval}{/if}" disabled/></span>
                                                                            </td>
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_subsription_guest_{$k|escape:'htmlall':'UTF-8'}_checked" type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['customer_subscription'][$k]['guest']['checked']|intval}" {if $velocity_supercheckout['customer_subscription'][$k]['guest']['checked'] eq 1}checked="checked"{/if} disabled/>{l s='Show as Checked' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="cus_subsription_guest_{$k|escape:'htmlall':'UTF-8'}_display" type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['customer_subscription'][$k]['guest']['display']|intval}" {if $velocity_supercheckout['customer_subscription'][$k]['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="reorder">
                                                                ...
                                                                <tbody class="">
                                                                    <tr id="use_delivery_for_payment_add" class="free-disabled">
                                                                        ...
                                                                        <td class="left drag-col-2 col-pad-left">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                <label class="checkboxinline no-bold">
                                                                                    <input id="use_delivery_for_payment_add_guest" type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['use_delivery_for_payment_add']['guest']|intval}" {if $velocity_supercheckout['use_delivery_for_payment_add']['guest'] eq 1}checked="checked"{/if} disabled/>{l s='Show as Checked' mod='supercheckout'}                                                                        
                                                                                </label>
                                                                                <label class="checkboxinline no-bold">
                                                                                    <input id="show_use_delivery_for_payment_add_guest" type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['show_use_delivery_for_payment_add']['guest']|intval}" {if $velocity_supercheckout['show_use_delivery_for_payment_add']['guest'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                        <td class="left drag-col-2">
                                                                            <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                <label class="checkboxinline no-bold">
                                                                                    <input id="use_delivery_for_payment_add_logged" type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['use_delivery_for_payment_add']['logged']|intval}" {if $velocity_supercheckout['use_delivery_for_payment_add']['logged'] eq 1}checked="checked"{/if} disabled/>{l s='Show as Checked' mod='supercheckout'}                                                                        
                                                                                </label>
                                                                                <label class="checkboxinline no-bold">
                                                                                    <input id="show_use_delivery_for_payment_add_logged" type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['show_use_delivery_for_payment_add']['logged']|intval}" {if $velocity_supercheckout['show_use_delivery_for_payment_add']['logged'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}
                                                                                </label>
                                                                            </div>
                                                                        </td>
							    ...
							    <table class="form alternate">
                                                            	...
                                                            	{foreach from=$velocity_supercheckout['shipping_address'] key='k' item = 'p_addr'}
                                                                        <tr id="customer_personal_{$velocity_supercheckout['shipping_address'][$k]['id']|escape:'htmlall':'UTF-8'}_input" class="sort-item free-disabled" sort-data="{if isset($velocity_supercheckout['shipping_address'][$k]['sort_order'])}{$velocity_supercheckout['shipping_address'][$k]['sort_order']|intval}{/if}">
                                                                            <input type="hidden" value="{$velocity_supercheckout['shipping_address'][$k]['id']|escape:'htmlall':'UTF-8'}"  disabled/>
                                                                            <input type="hidden" value="{$velocity_supercheckout['shipping_address'][$k]['title']|escape:'htmlall':'UTF-8'}"  disabled/>
                                                                            <input type="hidden" value="{$velocity_supercheckout['shipping_address'][$k]['conditional']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <td class="name">
                                                                               <span>{l s=$velocity_supercheckout['shipping_address'][$k]['title']|escape:'htmlall' mod='supercheckout'}:<input class="sort" class="input-sm form-control col-md-12" type="text" value="{if isset($velocity_supercheckout['shipping_address'][$k]['sort_order'])|intval}{$velocity_supercheckout['shipping_address'][$k]['sort_order']|intval}{/if}" disabled/></span>
                                                                            </td>
											...
											{else}
												<input id="shipping_address_guest_{$k|escape:'htmlall':'UTF-8'}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field"  value="{$velocity_supercheckout['shipping_address'][$k]['guest']['require']|intval}" {if $velocity_supercheckout['shipping_address'][$k]['guest']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}                                                                        
											{/if}
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="shipping_address_guest_{$k|escape:'htmlall':'UTF-8'}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field"  value="{$velocity_supercheckout['shipping_address'][$k]['guest']['display']|intval}" {if $velocity_supercheckout['shipping_address'][$k]['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
											...
											{else}
												<input id="shipping_address_logged_{$k|escape:'htmlall':'UTF-8'}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field"  value="{$velocity_supercheckout['shipping_address'][$k]['logged']['require']|intval}" {if $velocity_supercheckout['shipping_address'][$k]['logged']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}                                                                        
											{/if}
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="shipping_address_logged_{$k|escape:'htmlall':'UTF-8'}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field"  value="{$velocity_supercheckout['shipping_address'][$k]['logged']['display']|intval}" {if $velocity_supercheckout['shipping_address'][$k]['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    {if in_array($k, $highlighted_fields)}
                                                                                        <span style="color:red; margin-left: 5px;">*</span>
                                                                                    {/if}
                                                            ...
                                                            <table class="form alternate">
                                                                ...
                                                                <tbody class="sortable ui-sortable">
                                                                    {foreach from=$velocity_supercheckout['payment_address'] key='k' item = 'p_addr'}
                                                                        <tr id="customer_personal_{$velocity_supercheckout['payment_address'][$k]['id']|escape:'htmlall':'UTF-8'}_input" class="sort-item free-disabled" sort-data="{if isset($velocity_supercheckout['payment_address'][$k]['sort_order'])}{$velocity_supercheckout['payment_address'][$k]['sort_order']|intval}{/if}">
                                                                            <input type="hidden" value="{$velocity_supercheckout['payment_address'][$k]['id']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input type="hidden" value="{$velocity_supercheckout['payment_address'][$k]['title']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input type="hidden" value="{$velocity_supercheckout['payment_address'][$k]['conditional']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <td class="name">
                                                                               <span>{l s=$velocity_supercheckout['payment_address'][$k]['title'] mod='supercheckout'}:<input class="sort" class="input-sm form-control col-md-12" type="text" value="{if isset($velocity_supercheckout['payment_address'][$k]['sort_order'])}{$velocity_supercheckout['payment_address'][$k]['sort_order']|intval}{/if}"  disabled/></span>
                                                                            </td>
											...
											{else}
												<input id="payment_address_guest_{$k|escape:'htmlall':'UTF-8'}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field"  value="{$velocity_supercheckout['payment_address'][$k]['guest']['require']|intval}" {if $velocity_supercheckout['payment_address'][$k]['guest']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}
											{/if}
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="payment_address_guest_{$k|escape:'htmlall':'UTF-8'}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field"  value="{$velocity_supercheckout['payment_address'][$k]['guest']['display']|intval}" {if $velocity_supercheckout['payment_address'][$k]['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    {if in_array($k, $highlighted_fields)}
                                                                                        <span style="color:red; margin-left: 5px;">*</span>
                                                                                    {/if}
											...
											{else}
												<input id="payment_address_logged_{$k|escape:'htmlall':'UTF-8'}_require" type="checkbox" class="checkbox input-checkbox-option require_address_field" value="{$velocity_supercheckout['payment_address'][$k]['logged']['require']|intval}" {if $velocity_supercheckout['payment_address'][$k]['logged']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}
											{/if}
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input id="payment_address_logged_{$k|escape:'htmlall':'UTF-8'}_display" type="checkbox" class="checkbox input-checkbox-option display_address_field"  value="{$velocity_supercheckout['payment_address'][$k]['logged']['display']|intval}" {if $velocity_supercheckout['payment_address'][$k]['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    {if in_array($k, $highlighted_fields)}
                                                                                        <span style="color:red; margin-left: 5px;">*</span>
                                                                                    {/if}
                                                            ...
                                                            <table class="form">
                                                                ...
                                                                <tr class="free-disabled">
                                                                    ...
                                                                    <td class="left settings">
                                                                        <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="0"  {if $velocity_supercheckout['payment_method']['display_style'] eq 0} checked="checked" {/if} disabled/>{l s='Text Only' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="1" {if $velocity_supercheckout['payment_method']['display_style'] eq 1} checked="checked" {/if} disabled/>{l s='Text With Image' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="2" {if $velocity_supercheckout['payment_method']['display_style'] eq 2} checked="checked" {/if} disabled/>{l s='Image Only' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr class="free-disabled">
                                                                    ...
                                                                    <td class="settings">
                                                                        <div class='span4'>
                                                                            <select {if $ps_version eq 15}class="selectpicker vss_sc_ver15"{/if}  disabled>
                                                                ...
                                                                <tr class="free-disabled">
                                                                    ...
                                                                    <tr class="free-disabled">
                                                                        ...
                                                                        <td><div class="span6">
                                                                            <input type="text" class="text-width" value="{if isset($velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['title'][{$lang['id_lang']|intval}])}{$velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['title'][{$lang['id_lang']|intval}]|escape:'htmlall':'UTF-8'}{else}{$pay_methods['display_name']|escape:'htmlall':'UTF-8'}{/if}" disabled/>                                                                                                                                                
																		...
																		<div class="logo-img" style='padding-left: 10px;padding-top:10px;margin-bottom:15px;'>
																			{if isset($velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['title']) && $velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['title'] != ""}
																				{if !file_exists("{$root_dir|escape:'htmlall':'UTF-8'}/modules/supercheckout/views/img/admin/uploads/{$velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['title']|escape:'htmlall':'UTF-8'}")}
																					<input type="hidden" id="payment_image_title_{$pay_methods['id_module']|intval}" value="" disabled/>
					...
					{else}
																				<input type="hidden"  id="payment_image_title_{$pay_methods['id_module']|intval}" value="{$velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['title']|escape:'htmlall':'UTF-8'}" disabled/>
                ...
                <div style='padding-left: 10px;'>
                    <span style="display: inline-block;"> <input type="file" id="payment-img-{$pay_methods['id_module']|intval}_file" onchange="readPaymentURL({$pay_methods['id_module']|intval},'payment-img-{$pay_methods['id_module']|intval}')" value="" disabled></span><span><input type='button' class="btn btn-primary"  value='{l s='Remove' mod='supercheckout'}' disabled/></span> <span id="payment-img-{$pay_methods['id_module']|intval}_msg" style="margin-left:10px; display:none;">{l s='Only Images allowed' mod='supercheckout'}</span>
                </div>
																		</div>
				<div style="margin-top: 10px;display:flex;padding-left: 10px;">
					...
					<div class="input-group" style="width: 20%;"><input type="text"  class="form-control" value="{if isset($velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['resolution']['width'])}{$velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['resolution']['width']|escape:'htmlall':'UTF-8'}{else}auto{/if}" disabled/><span class="input-group-addon" style="width: 10px;">{l s='px' mod='supercheckout'}</span></div>
					<span style="padding: 5px 10px 0px 10px;">{l s='Height' mod='supercheckout'}</span>		<div class="input-group" style="width: 20%;"><input type="text" class="form-control"   value="{if isset($velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['resolution']['height'])}{$velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['resolution']['height']|escape:'htmlall':'UTF-8'}{else}auto{/if}" disabled/><span class="input-group-addon" style="width: 10px;">{l s='px' mod='supercheckout'}</span></div>
                                                            ...
                                                            <table class="form">
                                                                ...
                                                                <tr class="free-disabled">
                                                                    ...
                                                                    <td class="left settings">
                                                                        <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="0"  {if $velocity_supercheckout['shipping_method']['display_style'] eq 0} checked="checked" {/if} disabled/>{l s='Text Only' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="1" {if $velocity_supercheckout['shipping_method']['display_style'] eq 1} checked="checked" {/if} disabled/>{l s='Text With Image' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="2" {if $velocity_supercheckout['shipping_method']['display_style'] eq 2} checked="checked" {/if} disabled/>{l s='Image Only' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr class="free-disabled">
                                                                    ...
                                                                    <tr class="free-disabled">
                                                                        ...
                                                                        <td><div class="span6">
                                                                            <input type="text" class="text-width"  value="{if isset($velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['title'][{$lang['id_lang']|intval}])}{$velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['title'][{$lang['id_lang']|intval}]|escape:'htmlall':'UTF-8'}{else}{$carrier['name']|escape:'htmlall':'UTF-8'}{/if}" disabled/>                                                                                                                                                
																		...
																		<div class="logo-img" style='padding-left: 10px;padding-top:10px;margin-bottom:15px;'>
																			{if isset($velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['title']) && $velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['title'] != ""}
																				{if !file_exists("{$root_dir|escape:'htmlall':'UTF-8'}/modules/supercheckout/views/img/admin/uploads/{$velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['title']|escape:'htmlall':'UTF-8'}")}
																					<input type="hidden" id="delivery_image_title_{$carrier['id_carrier']|intval}" value="" disabled/>
					...
					{else}
																				<input type="hidden"  id="delivery_image_title_{$carrier['id_carrier']|intval}" value="{$velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['title']|escape:'htmlall':'UTF-8'}" disabled/>
																				<div>
                ...
                <div style='padding-left: 10px;'>
                    <span style="display: inline-block;"> <input type="file"  id="delivery-img-{$carrier['id_carrier']|intval}_file" onchange="readDeliveryURL({$carrier['id_carrier']|intval},'delivery-img-{$carrier['id_carrier']|intval}')" value="" disabled></span><span><input type='button' class="btn btn-primary"  value='{l s='Remove' mod='supercheckout'}' disabled/></span> <span id="delivery-img-{$carrier['id_carrier']|intval}_msg" style="margin-left:10px; display:none;">{l s='Only Images allowed' mod='supercheckout'}</span>
                </div>
																		</div>
				<div style="margin-top: 10px;display:flex;padding-left: 10px;">
					<span style="padding: 5px 10px 0px 0px;">{l s='Width' mod='supercheckout'}</span>
					<div class="input-group" style="width: 20%;">
						<input type="text"  class="form-control"  value="{if isset($velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['resolution']['width'])}{$velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['resolution']['width']|escape:'htmlall':'UTF-8'}{else}auto{/if}" disabled/><span class="input-group-addon" style="width: 10px;">{l s='px' mod='supercheckout'}</span></div>
		<span style="padding: 5px 10px 0px 10px;">{l s='Height' mod='supercheckout'}</span>		<div class="input-group" style="width: 20%;">		<input type="text" class="form-control"   value="{if isset($velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['resolution']['height'])}{$velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['resolution']['height']|escape:'htmlall':'UTF-8'}{else}auto{/if}" disabled/><span class="input-group-addon" style="width: 10px;">{l s='px' mod='supercheckout'}</span></div>
				</div><p class="help-block" style='padding-left: 10px;'> {l s='(To maintain aspect ratio of image, keep either both height and width value as auto or any of them value as auto)' mod='supercheckout'}</p>
																	</td>
																</tr>
							...
							<div style="margin-left: 5%;  margin-top:25px;width: 40%;  float: left;  border: 1px solid rgb(0, 0, 0);"> 
                                                            ...
                                                            <table class="form alternate">
                                                                ...
                                                                <tbody class="">
                                                                    {foreach from=$velocity_supercheckout['cart_options'] key='k' item = 'p_addr'}
                                                                        <tr class="free-disabled">
                                                                            <input type="hidden" value="{$velocity_supercheckout['cart_options'][$k]['id']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input type="hidden" value="{$velocity_supercheckout['cart_options'][$k]['title']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <td class="name"><span>{l s=$velocity_supercheckout['cart_options'][$k]['title'] mod='supercheckout'}:<input class="sort" class="input-sm form-control col-md-12" type="text" value="{if isset($velocity_supercheckout['cart_options'][$k]['sort_order'])}{$velocity_supercheckout['cart_options'][$k]['sort_order']|intval}{/if}"  disabled/></span></td>
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['cart_options'][$k]['guest']['display']|intval}" {if $velocity_supercheckout['cart_options'][$k]['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['cart_options'][$k]['logged']['display']|intval}" {if $velocity_supercheckout['cart_options'][$k]['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    {/foreach}
                                                                    <tr{if $ps_version eq 15} class="vss_scparent_ver15 free-disabled"{else}class="free-disabled"{/if}>
                                                                        ...
                                                                        <td class="left drag-col-2 col-pad-left">
                                                                                <div class='span1'><input type='text' {if $ps_version eq 15}class="form-control vss-form-control-ver15"{/if}  value='{$velocity_supercheckout['cart_image_size']['width']|intval}' disabled/></div>
                                                                                <div class="span0{if $ps_version eq 15} vss-resolution-ver15{/if}">X</div>
                                                                                <div class='span1'><input type='text' {if $ps_version eq 15}class="form-control vss-form-control-ver15"{/if}  value='{$velocity_supercheckout['cart_image_size']['height']|intval}' disabled/></div>
                                                                        </td>
                                                                        <td class="left drag-col-2">
								    ...
								    <tr{if $ps_version eq 15} class="vss_scparent_ver15 free-disabled"{else}class="free-disabled"{/if}>
                                                                        ...
                                                                        <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="0"  {if $velocity_supercheckout['qty_update_option'] eq 0} checked="checked" {/if} disabled/>{l s='+/- Button' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                            <label class="radio coupon_type_radio">
                                                                                <input type="radio" class="radio coupon_type_radio"  value="1" {if $velocity_supercheckout['qty_update_option'] eq 1} checked="checked" {/if} disabled/>{l s='Update Link' mod='supercheckout'}                                                                        
                                                                            </label>
                                                                        </div>
                                                                        </td>
                                                                        <td class="left drag-col-2">
                                                                ...
                                                                <tbody class="">
                                                                        <tr class="free-disabled">
                                                                            ...
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['order_total_option']['product_sub_total']['guest']['display']|intval}" {if $velocity_supercheckout['order_total_option']['product_sub_total']['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['order_total_option']['product_sub_total']['logged']['display']|intval}" {if $velocity_supercheckout['order_total_option']['product_sub_total']['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="free-disabled">
                                                                            ...
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option" value="{$velocity_supercheckout['order_total_option']['voucher']['guest']['display']|intval}" {if $velocity_supercheckout['order_total_option']['voucher']['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['order_total_option']['voucher']['logged']['display']|intval}" {if $velocity_supercheckout['order_total_option']['voucher']['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="free-disabled">
                                                                            ...
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['order_total_option']['shipping_price']['guest']['display']|intval}" {if $velocity_supercheckout['order_total_option']['shipping_price']['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['order_total_option']['shipping_price']['logged']['display']|intval}" {if $velocity_supercheckout['order_total_option']['shipping_price']['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="free-disabled">
                                                                            ...
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['order_total_option']['total']['guest']['display']|intval}" {if $velocity_supercheckout['order_total_option']['total']['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option" value="{$velocity_supercheckout['order_total_option']['total']['logged']['display']|intval}" {if $velocity_supercheckout['order_total_option']['total']['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <tbody class="">
                                                                        <tr class="free-disabled">
                                                                            ...
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['term_condition']['guest']['display']|intval}" {if $velocity_supercheckout['confirm']['term_condition']['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['term_condition']['guest']['require']|intval}" {if $velocity_supercheckout['confirm']['term_condition']['guest']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['term_condition']['guest']['checked']|intval}" {if $velocity_supercheckout['confirm']['term_condition']['guest']['checked'] eq 1}checked="checked"{/if} disabled/>{l s='Show as Checked' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                            ...
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['term_condition']['logged']['display']|intval}" {if $velocity_supercheckout['confirm']['term_condition']['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['term_condition']['logged']['require']|intval}" {if $velocity_supercheckout['confirm']['term_condition']['logged']['require'] eq 1}checked="checked"{/if} disabled/>{l s='Require' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['term_condition']['logged']['checked']|intval}" {if $velocity_supercheckout['confirm']['term_condition']['logged']['checked'] eq 1}checked="checked"{/if} disabled/>{l s='Show as Checked' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                    <i class="store_disabled" data-toggle="tooltip"  data-placement="top" data-original-title="{l s='This option will not display, if disable from default prestashop settings' mod='supercheckout'}"><span class="store_disabled_msg">{l s='Warning' mod='supercheckout'} !</span></i>
                                                                                </div>
                                                                            </td>
                                                                        ...
                                                                        <tr class="free-disabled">
                                                                            ...
                                                                            <td class="left drag-col-2 col-pad-left">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['order_comment_box']['guest']['display']|intval}" {if $velocity_supercheckout['confirm']['order_comment_box']['guest']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                            <td class="left drag-col-2">
                                                                                <div class="widget-body uniformjs" style="padding: 0 !important;">
                                                                                    <label class="checkboxinline no-bold">
                                                                                        <input type="checkbox" class="checkbox input-checkbox-option"  value="{$velocity_supercheckout['confirm']['order_comment_box']['logged']['display']|intval}" {if $velocity_supercheckout['confirm']['order_comment_box']['logged']['display'] eq 1}checked="checked"{/if} disabled/>{l s='Show' mod='supercheckout'}                                                                        
                                                                                    </label>
                                                                                </div>
                                                                            </td>
                                                                        </tr>                                                                
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        {foreach from=$velocity_supercheckout['design']['html'] key='k' item='v'}
                                                                            <input id="1_col_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort col-data"  value="{$velocity_supercheckout['design']['html'][$k]['1_column']['column']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input id="1_row_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort row-data"  value="{$velocity_supercheckout['design']['html'][$k]['1_column']['row']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input id="1_col_ins_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort col-data-inside" value="{$velocity_supercheckout['design']['html'][$k]['1_column']['column-inside']|escape:'htmlall':'UTF-8'}" disabled/>

                                                                            <input id="2_col_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort col-data"  value="{$velocity_supercheckout['design']['html'][$k]['2_column']['column']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input id="2_row_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort row-data"  value="{$velocity_supercheckout['design']['html'][$k]['2_column']['row']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input id="2_col_ins_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort col-data-inside" value="{$velocity_supercheckout['design']['html'][$k]['2_column']['column-inside']|escape:'htmlall':'UTF-8'}" disabled/>

                                                                            <input id="3_col_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort col-data" value="{$velocity_supercheckout['design']['html'][$k]['3_column']['column']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input id="3_row_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort row-data"  value="{$velocity_supercheckout['design']['html'][$k]['3_column']['row']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            <input id="3_col_ins_h_{$k|escape:'htmlall':'UTF-8'}"  type="hidden"  class="sort col-data-inside"  value="{$velocity_supercheckout['design']['html'][$k]['3_column']['column-inside']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                        {/foreach}
                                                                        ...
                                                                        {foreach from=$velocity_supercheckout['design'] key='tab_name' item='v'}
                                                                            ...
                                                                            {foreach from=$velocity_supercheckout['design'][$tab_name] key='col_name' item='v1'}
                                                                                <input   type="hidden"  class="sort col-data" value="{$velocity_supercheckout['design'][$tab_name][$col_name]['column']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                                <input   type="hidden"  class="sort row-data" value="{$velocity_supercheckout['design'][$tab_name][$col_name]['row']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                                <input   type="hidden"  class="sort col-data-inside" value="{$velocity_supercheckout['design'][$tab_name][$col_name]['column-inside']|escape:'htmlall':'UTF-8'}" disabled/>
                                                                            {/foreach}
                                                                            {/if}
                                                                        {/foreach}                                                                
                                                                        ...
                                                                        <!-- Start - Header and footer Html -->                                                                    
                                                                            <input type="hidden" id="modals_bootbox_prompt_html_header_value" value="{if $velocity_supercheckout['html_value']['header'] neq ''}{html_entity_decode($velocity_supercheckout['html_value']['header'])|escape:'html':'UTF-8'}{/if}" disabled/>
                                                                            <input type="hidden" id="modals_bootbox_prompt_html_footer_value"  value="{if $velocity_supercheckout['html_value']['footer'] neq ''}{html_entity_decode($velocity_supercheckout['html_value']['footer'])|escape:'html':'UTF-8'}{/if}" disabled/>
                                                                        ...
                                                                        {if $layout eq 3}
                                                                            ...
                                                                            <td  colspan="2" style="position:static">
                                                                                ...
                                                                                <div class="columns">
                                                                                    <input type="hidden"  class="column-data-1 col"  value="{$velocity_supercheckout['column_width']['1_column'][1]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-2 col"  value="{$velocity_supercheckout['column_width']['1_column'][2]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-2 col"  value="{$velocity_supercheckout['column_width']['1_column'][3]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-3 col"  value="{$velocity_supercheckout['column_width']['1_column']['inside'][1]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-3 col"  value="{$velocity_supercheckout['column_width']['1_column']['inside'][2]|intval}" disabled/>

                                                                                    <input type="hidden"  class="column-data-1 col"  value="{$velocity_supercheckout['column_width']['2_column'][1]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-2 col" value="{$velocity_supercheckout['column_width']['2_column'][2]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-2 col"  value="{$velocity_supercheckout['column_width']['2_column'][3]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-3 col"  value="{$velocity_supercheckout['column_width']['2_column']['inside'][1]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-3 col" value="{$velocity_supercheckout['column_width']['2_column']['inside'][2]|intval}" disabled/>

                                                                                    <input type="hidden"  class="column-data-3 col"  value="{$velocity_supercheckout['column_width']['3_column']['inside'][1]|intval}" disabled/>
                                                                                    <input type="hidden"  class="column-data-3 col"  value="{$velocity_supercheckout['column_width']['3_column']['inside'][2]|intval}" disabled/>
                                                                                    <input type="text" id="three-column-1" readonly="readonly" class="column-data-1 col"  value="{$velocity_supercheckout['column_width']['3_column'][1]|intval}" disabled/>
                                                                                    <input type="text" id="three-column-2" readonly="readonly" class="column-data-2 col"  value="{$velocity_supercheckout['column_width']['3_column'][2]|intval}" disabled/>
                                                                                    <input type="text" id="three-column-3" readonly="readonly" class="column-data-3 col"  value="{$velocity_supercheckout['column_width']['3_column'][3]|intval}" disabled/>
                                                                                </div>
                                                                                ...
                                                                                <ul id="column_1" class="column column-1 layout_list_height" col-data="1">
                                                                                    <li class="portlet" col-data="{$velocity_supercheckout['design']['payment_address']['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['payment_address']['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content">
                                                                                            ...
                                                                                            <input   type="text"  class="sort col-data"  value="{$velocity_supercheckout['design']['payment_address']['3_column']['column']|intval}" disabled/>
                                                                                            <input   type="text"  class="sort row-data" value="{$velocity_supercheckout['design']['payment_address']['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li class="portlet" col-data="{$velocity_supercheckout['design']['login']['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['login']['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content">
                                                                                            ...
                                                                                            <div class="text"><i class="icon-drag"></i><i class="icon-drag"></i></div>
                                                                                            <input   type="text"  class="sort col-data" value="{$velocity_supercheckout['design']['login']['3_column']['column']|intval}" disabled/>
                                                                                            <input   type="text"  class="sort row-data"  value="{$velocity_supercheckout['design']['login']['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li class="portlet" col-data="{$velocity_supercheckout['design']['shipping_address']['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['shipping_address']['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content">
                                                                                            ...
                                                                                            <div class="text"><i class="icon-drag"></i><i class="icon-drag"></i></div>
                                                                                            <input   type="text"  class="sort col-data"  value="{$velocity_supercheckout['design']['shipping_address']['3_column']['column']|intval}" disabled/>
                                                                                            <input   type="text"  class="sort row-data"  value="{$velocity_supercheckout['design']['shipping_address']['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li class="portlet" col-data="{$velocity_supercheckout['design']['shipping_method']['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['shipping_method']['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content">
                                                                                            ...
                                                                                            <div class="text"><i class="icon-drag"></i><i class="icon-drag"></i></div>
                                                                                            <input   type="text"  class="sort col-data"  value="{$velocity_supercheckout['design']['shipping_method']['3_column']['column']|intval}" disabled/>
                                                                                            <input   type="text"  class="sort row-data"  value="{$velocity_supercheckout['design']['shipping_method']['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li class="portlet" col-data="{$velocity_supercheckout['design']['payment_method']['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['payment_method']['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content">
                                                                                            ...
                                                                                            <div class="text"><i class="icon-drag"></i><i class="icon-drag"></i></div>
                                                                                            <input   type="text"  class="sort col-data"  value="{$velocity_supercheckout['design']['payment_method']['3_column']['column']|intval}" disabled/>
                                                                                            <input   type="text"  class="sort row-data"  value="{$velocity_supercheckout['design']['payment_method']['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li class="portlet" col-data="{$velocity_supercheckout['design']['cart']['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['cart']['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content">
                                                                                            ...
                                                                                            <div class="text"><i class="icon-drag"></i><i class="icon-drag"></i></div>
                                                                                            <input   type="text"  class="sort col-data" value="{$velocity_supercheckout['design']['cart']['3_column']['column']|intval}" disabled/>
                                                                                            <input   type="text"  class="sort row-data"  value="{$velocity_supercheckout['design']['cart']['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li class="portlet" col-data="{$velocity_supercheckout['design']['confirm']['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['confirm']['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content">
                                                                                            ...
                                                                                            <div class="text"><i class="icon-drag"></i><i class="icon-drag"></i></div>
                                                                                            <input   type="text"  class="sort col-data"  value="{$velocity_supercheckout['design']['confirm']['3_column']['column']|intval}" disabled/>
                                                                                            <input   type="text"  class="sort row-data" value="{$velocity_supercheckout['design']['confirm']['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>
                                                                                  ...
                                                                                  {foreach from=$velocity_supercheckout['design']['html'] key='k' item='v'}
                                                                                    <li class="portlet" id="portlet_{$k|escape:'htmlall':'UTF-8'}" col-data="{$velocity_supercheckout['design']['html'][$k]['3_column']['column']|intval}" row-data="{$velocity_supercheckout['design']['html'][$k]['3_column']['row']|intval}">
                                                                                        ...
                                                                                        <div class="portlet-content" id="portlet_content_{$k|escape:'htmlall':'UTF-8'}">
                                                                                            ...
                                                                                            <input id="col_text_{$k|escape:'htmlall':'UTF-8'}"   type="text"  class="sort col-data" value="{$velocity_supercheckout['design']['html'][$k]['3_column']['column']|intval}" disabled/>
                                                                                            <input id="row_text_{$k|escape:'htmlall':'UTF-8'}"  type="text"  class="sort row-data"  value="{$velocity_supercheckout['design']['html'][$k]['3_column']['row']|intval}" disabled/>
                                                                                        </div>
                                                                                    </li>                                                    
                                                                                    {/foreach}
                                                                                </ul>
                                                    ...
                                                    <!--------------- End - Design -------------------->
                                                    <input type="hidden" id="modal_value"  value="{$velocity_supercheckout['modal_value']|escape:'htmlall':'UTF-8'}" disabled/>
                                                    <div id="extra_html_container">
                                                    {foreach from=$velocity_supercheckout['design']['html'] key='k' item='v'}
                                                        <input type="hidden" id="modals_bootbox_prompt_{$k|escape:'htmlall':'UTF-8'}"  value="{html_entity_decode($velocity_supercheckout['design']['html'][{$k|escape:'htmlall':'utf-8'}]['value'])|escape:'html':'utf-8'}" disabled/>
                                                    {/foreach}
                                                    </div>
</form>
