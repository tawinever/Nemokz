<?php /* Smarty version Smarty-3.1.19, created on 2016-11-20 19:30:29
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13707585575831a575cbbca6-63986907%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dfb590e139952bf5ef3cc547e54790f8509998ff' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/product.tpl',
      1 => 1479480726,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13707585575831a575cbbca6-63986907',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5831a5764182e0_22207052',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5831a5764182e0_22207052')) {function content_5831a5764182e0_22207052($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/tools/smarty/plugins/function.counter.php';
?>
		...
		<div class="pb-left-column col-xs-12 col-sm-4 col-md-5">
			...
			<div id="image-block" class="clearfix">
				...
				<?php } elseif ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value) {?>
					<span class="offercount-product"><?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='percentage') {?>-<?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']*100;?>
%<?php }?></span>
				<?php }?>
						...
						<div class="box-info-product">
							<div class="content_prices clearfix">
								<?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
									<!-- prices -->
									<div>
										<p class="our_price_display" itemprop="offers" itemscope itemtype="https://schema.org/Offer"><?php if ($_smarty_tpl->tpl_vars['product']->value->quantity>0) {?><link itemprop="availability" href="https://schema.org/InStock"/><?php }?><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?><span class="price-label">Цена: </span><span id="our_price_display" class="price" itemprop="price" content="<?php echo $_smarty_tpl->tpl_vars['productPrice']->value;?>
...
<?php }?>
											<span id="old_price"<?php if ((!$_smarty_tpl->tpl_vars['product']->value->specificPrice||!$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])) {?> class="hidden"<?php }?>><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayProductPriceBlock",'product'=>$_smarty_tpl->tpl_vars['product']->value,'type'=>"old_price"),$_smarty_tpl);?>
<span id="old_price_display"><span class="old-price"><?php if ($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value)),$_smarty_tpl);?>
...
%
		...
		<?php if (isset($_smarty_tpl->tpl_vars['product']->value)) {?>
			...
			<div class="extended-container">
				<div class="container">
					<section class="page-product-pros">
							<a>
								<i class="ship"></i><br>Оплата после получения заказа
								<div class="helper">
									<p><b>Наличный и безналичный рассчет</b></p><p>Оплатить покупку Вы можете любым удобным для вас способом. Мы работаем по наличному и безналичному расчету.&nbsp;</p>
								</div>
							</a>
							<a>
								<i class="qual"></i><br>Гарантия качества всех товаров
								<div class="helper">
									<p><b>Наличный и безналичный рассчет</b></p><p>Оплатить покупку Вы можете любым удобным для вас способом. Мы работаем по наличному и безналичному расчету.&nbsp;</p>
								</div>
							</a>
							<a>
								<i class="cashback"></i><br>Доставка по Астане бесплатно
								<div class="helper">
									<p><b>Наличный и безналичный рассчет</b></p><p>Оплатить покупку Вы можете любым удобным для вас способом. Мы работаем по наличному и безналичному расчету.&nbsp;</p>
								</div>
							</a>
							<a>
								<i class="supp"></i><br>Возврат товара в течение 30 дней
								<div class="helper">
									<p><b>Наличный и безналичный рассчет</b></p><p>Оплатить покупку Вы можете любым удобным для вас способом. Мы работаем по наличному и безналичному расчету.&nbsp;</p>
								</div>
							</a>
							<a>
								<i class="consult"></i><br>Бесплатный звонок <br>8 (800) 555-47-85
								<div class="helper">
									<p><b>Наличный и безналичный рассчет</b></p><p>Оплатить покупку Вы можете любым удобным для вас способом. Мы работаем по наличному и безналичному расчету.&nbsp;</p>
								</div>
							</a>
