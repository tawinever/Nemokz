<?php /* Smarty version Smarty-3.1.19, created on 2016-11-20 19:30:29
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/modules/mailalerts/views/templates/hook/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9648588815831a575b039f6-30548481%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '266362638c0ac59bfd49d620107f24082a1b7c7b' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/modules/mailalerts/views/templates/hook/product.tpl',
      1 => 1479471879,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9648588815831a575b039f6-30548481',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5831a575b32593_34609975',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5831a575b32593_34609975')) {function content_5831a575b32593_34609975($_smarty_tpl) {?>
<!-- MODULE MailAlerts -->
	<?php if (isset($_smarty_tpl->tpl_vars['email']->value)&&$_smarty_tpl->tpl_vars['email']->value) {?>
		<p class="form-group">
			<input type="text" id="oos_customer_email" name="customer_email" size="20" placeholder="Введите ваш адрес электронной почты" class="mailalerts_oos_email form-control" />
    	</p>
    <?php }?>
	<a href="#" class="mailalert-cta-btn" title="<?php echo smartyTranslate(array('s'=>'Notify me when available','mod'=>'mailalerts'),$_smarty_tpl);?>
