<?php /* Smarty version Smarty-3.1.19, created on 2016-12-13 20:09:56
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/modules/hspointofsalepro/abstract/views/templates/admin/hs_point_of_sale_completed_orders_abstract/helpers/list/list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1043772497585001343caaa4-25384723%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd948ca5e8614e01e5f86fb0d5c165125ea051ce2' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/modules/hspointofsalepro/abstract/views/templates/admin/hs_point_of_sale_completed_orders_abstract/helpers/list/list_content.tpl',
      1 => 1480187258,
      2 => 'file',
    ),
    '323fd7ea74a6320ac4586a351b803c643558b3ac' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/rauan/themes/default/template/helpers/list/list_content.tpl',
      1 => 1473152712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1043772497585001343caaa4-25384723',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5850013460dfd1_60596702',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5850013460dfd1_60596702')) {function content_5850013460dfd1_60596702($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/tools/smarty/plugins/function.counter.php';
?>
...
?>
    ...
    <td
        <?php if (isset($_smarty_tpl->tpl_vars['params']->value['position'])) {?>
                id="td_<?php if (!empty($_smarty_tpl->tpl_vars['position_group_identifier']->value)) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['position_group_identifier']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php } else { ?>0<?php }?>_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['identifier']->value], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php if (Smarty::$_smarty_vars['capture']['tr_count']>1) {?>_<?php echo intval((Smarty::$_smarty_vars['capture']['tr_count']-1));?>
<?php }?>"
        <?php }?>
        class="<?php if (!$_smarty_tpl->tpl_vars['no_link']->value) {?>pointer<?php }?><?php if (isset($_smarty_tpl->tpl_vars['params']->value['position'])&&$_smarty_tpl->tpl_vars['order_by']->value=='position'&&$_smarty_tpl->tpl_vars['order_way']->value!='DESC') {?> dragHandle<?php }?><?php if (isset($_smarty_tpl->tpl_vars['params']->value['class'])) {?> <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['params']->value['class'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?><?php if (isset($_smarty_tpl->tpl_vars['params']->value['align'])) {?> <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['params']->value['align'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?>"
        <?php if ((!isset($_smarty_tpl->tpl_vars['params']->value['position'])&&!$_smarty_tpl->tpl_vars['no_link']->value&&!isset($_smarty_tpl->tpl_vars['params']->value['remove_onclick']))) {?>
                onclick="window.open('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders'), ENT_QUOTES, 'UTF-8', true);?>
...
&amp;view<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['table']->value, ENT_QUOTES, 'UTF-8', true);?>
