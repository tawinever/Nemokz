<?php /* Smarty version Smarty-3.1.19, created on 2016-11-20 19:18:43
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5721307265831a2b31ba857-12391008%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6f8b6711a9212ab53d5701cceb03e0e5e48a84c0' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/header.tpl',
      1 => 1479634767,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5721307265831a2b31ba857-12391008',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5831a2b32ca701_43052070',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5831a2b32ca701_43052070')) {function content_5831a2b32ca701_43052070($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
					...
					<?php }?>
					<div class="display-top-container">
						<div class="container">
							<div class="row">
...
<?php }?>
					...
					<div class="nav-menu-container">
						<div class="container">
							<div class="nav-menu">
								<a class="menu-item active" href="#">Главная</a>
								<a class="menu-item" href="#">О Магазине</a>
								<a class="menu-item" href="#">Доставка</a>
								<a class="menu-item" href="#">Оплата</a>
								<a class="menu-item" href="#">Скидки</a>
