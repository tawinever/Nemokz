<?php /* Smarty version Smarty-3.1.19, created on 2016-11-20 19:18:43
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/modules/homeslider/homeslider.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10336647475831a2b32d8421-48592763%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5ba3e3b7e9e38f1381571eaddf7ee4390ae6283' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/nemo.dev/themes/cover/modules/homeslider/homeslider.tpl',
      1 => 1478201985,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10336647475831a2b32d8421-48592763',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5831a2b3331923_83521297',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5831a2b3331923_83521297')) {function content_5831a2b3331923_83521297($_smarty_tpl) {?>
			...
			<div id="advantages" class="clearfix">
				<div class="col-sm-12 clearfix">
					<div class="col-sm-6 col-md-3">
						<a> <i class="ship"></i><br><br>Оплата после получения заказа </a>
					</div>
					<div class="col-sm-6 col-md-3">
						<a> <i class="qual"></i><br><br>Доставка по Астане бесплатно </a>
					</div>
					<div class="col-sm-6 col-md-3">
						<a> <i class="cashback"></i><br><br>Возврат товара в течение 30 дней </a>
					</div>
					<div class="col-sm-6 col-md-3">
						<a> <i class="supp"></i><br><br>Гарантия качества всех товаров</a>
					</div>
				</div>
			</div>
		</div>
