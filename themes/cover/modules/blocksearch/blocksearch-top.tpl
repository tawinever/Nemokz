...
<div id="search_block_top" class="col-sm-6 clearfix">
	...
	<form id="searchbox" method="get" action="{$link->getPageLink('search', null, null, null, false, null, true)|escape:'html':'UTF-8'}" >
		...
		<input class="search_query form-control" type="text" id="search_query_top" name="search_query" placeholder="Например: чехол для iPhone 6" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
